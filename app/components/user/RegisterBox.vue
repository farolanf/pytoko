<template lang="pug">
    div
        ...
        form(@submit.prevent="submit")
            ...
            input-field(type="password" name="password_confirm" title="Ulang password" required left-icon="fa fa-lock" placeholder="Password lagi" v-model="passwordConfirm" :error="hasError('password_confirm')" :error-msg="getError('password_confirm')")
